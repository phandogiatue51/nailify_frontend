...
export const EditBlogPostPage = () => {
  ...
  if (loading) return (
    <div className="flex flex-col h-[60vh] items-center justify-center gap-4">
      ...
      <p className="text-[10px] font-black uppercase tracking-widest text-slate-400">Retrieving Post</p>
    </div>
  );
    ...
    <div className="min-h-screen bg-white pb-10">
      ...
      <nav className="sticky top-0 z-50 bg-white/80 backdrop-blur-xl border-b border-slate-50 px-6 py-4 flex items-center justify-between">
        ...
        <div className="flex flex-col items-center">
          <span className="text-[10px] font-black uppercase tracking-[0.4em] text-slate-400">Editor</span>
